...
import com.underpressure.backend.controllers.classes.abstracts.GetControllerUpdated;
import com.underpressure.backend.controllers.classes.request.params.GetSubjectsParams;
import com.underpressure.backend.controllers.helpers.Fetch;

@RestController
public class FetchSubjectsController extends GetControllerUpdated<List<String>, GetSubjectsParams> {
