...
public class AddEntryControllerTests {
    ...
    @Test
    public void Should_Result_In_Bad_Request_If_StressLevel_Null() {
        ResponseEntity<ApiResponse<String>> responseEntity = controller
    ...
    @Test
    public void Should_Result_In_Not_Found_Exception_If_Stress_Level_Out_Of_Range() {
        ResponseEntity<ApiResponse<String>> responseEntity = controller
    ...
    @Test
    public void Should_Result_In_Bad_Request_If_Not_Followed() {
        ResponseEntity<ApiResponse<String>> responseEntity = controller
    ...
    @Test
    public void Should_Add_Entry_If_Request_Valid() {
        ResponseEntity<ApiResponse<String>> responseEntity = controller
    ...
    @Test
    public void Should_Update_Entry_If_Request_Valid() {
        controller
